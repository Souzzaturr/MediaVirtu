(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();function p(){return`
    ...
    `}const u={opcoes:["Inicio","Sobre","Ajuda","Feedback","Configurações"],enderecos_icones:["public/icones/menu_lateral_icons/icone-inicio.png","public/icones/menu_lateral_icons/icone-sobre.png","public/icones/menu_lateral_icons/icone-ajuda.png","public/icones/menu_lateral_icons/icone-feedback.png","public/icones/menu_lateral_icons/icone-configuracoes.svg"]},m={opcoes:["Meu Perfil","Postar","Excluir","Denunciar","sair"],enderecos_icones:["public/icones/menu_lateral_icons/icone-perfil.png","public/icones/menu_lateral_icons/icone-postar.png","public/icones/menu_lateral_icons/icone-excluir.svg","public/icones/menu_lateral_icons/icone-denunciar.png","public/icones/menu_lateral_icons/icone-sair.png"]},n={sidebar_left:u,sidebar_right:m};function f(){let e,a;const t=[0,1,2,3,4];var i='<section id = "barra-esquerda" class = "bg-blbl rgb-border-fade">';return t.forEach(o=>{e=n.sidebar_left.opcoes[o],a=n.sidebar_left.enderecos_icones[o],i+=`
...
`).map(c=>`<p>${c}</p>`).join("")}
    ...
    `}function $(){return L(h.map(e=>_(e.nome,e.foto_perfil?e.foto_perfil:"../../public/pictures/MediaVirtu_icon.png",e.tempo_postagem,e.texto,e.imagens)+v())).join("")}function L(e){for(let a=e.length-1;a>0;a--){const t=Math.floor(Math.random()*(a+1));[e[a],e[t]]=[e[t],e[a]]}return e}function A(e){switch(e){case"Inicio":return $();case"Sobre":case"Ajuda":case"Feedback":case"Configurações":case"Meu Perfil":case"Postar":case"Excluir":case"Denunciar":case"sair":return"<div class = 'bloco'> Aguardem sensacionais revelações... </div>"}}var l="Inicio";const E=document.querySelector("#root");function x(){E.innerHTML=`
    ${p()}
    ${b()}
