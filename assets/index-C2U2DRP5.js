(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function s(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(e){if(e.ep)return;e.ep=!0;const n=s(e);fetch(e.href,n)}})();function v(){return`
    ...
    `}const h={opcoes:["Inicio","Sobre","Ajuda","Feedback","Configurações"],enderecos_icones:["icones/menu_lateral_icons/icone-inicio.png","icones/menu_lateral_icons/icone-sobre.png","icones/menu_lateral_icons/icone-ajuda.png","icones/menu_lateral_icons/icone-feedback.png","icones/menu_lateral_icons/icone-configuracoes.svg"]},I={opcoes:["Meu Perfil","Postar","Excluir","Denunciar","sair"],enderecos_icones:["icones/menu_lateral_icons/icone-perfil.png","icones/menu_lateral_icons/icone-postar.png","icones/menu_lateral_icons/icone-excluir.svg","icones/menu_lateral_icons/icone-denunciar.png","icones/menu_lateral_icons/icone-sair.png"]},g={sidebar_left:h,sidebar_right:I};function x(){let o,a;const s=[0,1,2,3,4];var t='<section id = "barra-esquerda" class = "bg-blbl rgb-border-fade">';return s.forEach(e=>{o=g.sidebar_left.opcoes[e],a=g.sidebar_left.enderecos_icones[e],t+=`
        ...
        <a id = "${o}" class = "opcao-barra-lateral" href = "" data-page = "${o}">
            ...
            <h3 class = "texto-opc-lateral goldman-bold">${o}</h3>
        </a>`}),t+="</section>",t}function k(){return'<nav id = "barras-navegacao-laterais">'+x()+S()+"</nav>"}function y(){return`
    ...
    `}function A(o,a,s,t,e=[],n,i,l="xxxxxxxxxx"){const d=t.length>0?`<div class = "conteudo-shitpost">
        ${t.split(`
`).map(u=>`<p>${u}</p>`).join("")}
    ...
    `}function w(o=0,a){const s=JSON.parse(localStorage.getItem("banco_usuarios")||"{}"),t=localStorage.getItem("usuario_atual"),e=t!=""&&s[t].likes.includes(a)?"-press":"";return`
    ...
    `}function $(o=0,a){const s=JSON.parse(localStorage.getItem("banco_usuarios")||"{}"),t=localStorage.getItem("usuario_atual"),e=t!=""&&s[t].dislikes.includes(a)?"-press":"";return`
    ...
    `}function C(o){const a=JSON.parse(localStorage.getItem("banco_comentarios")||"[]");let s=0;return a.forEach(t=>t.para_post==o?s++:""),`
